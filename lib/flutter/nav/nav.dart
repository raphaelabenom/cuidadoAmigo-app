...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'animalCreate',
          path: '/animalCreate',
          builder: (context, params) => AnimalCreateWidget(),
        ),
        FFRoute(
          name: 'homePage',
          path: '/homePage',
        ...
        FFRoute(
          ...
          builder: (context, params) => ProfileDetailsWidget(
            caregiverRef: params.getParam('caregiverRef',
                ParamType.DocumentReference, false, ['service', 'caregiver']),
          ),
        ),
        FFRoute(
          name: 'animalList',
          path: '/animalList',
          builder: (context, params) => AnimalListWidget(),
        ),
        FFRoute(
          name: 'profileEdit',
          path: '/profileEdit',
        ...
        FFRoute(
          ...
          builder: (context, params) => AnimalDetailsWidget(
            animalRef: params.getParam(
                'animalRef', ParamType.DocumentReference, false, ['animal']),
          ),
        )
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Center(
                    child: Image.asset(
                      'assets/images/passaro-do-amor.png',
                      width: 200.0,
                      height: 200.0,
                      fit: BoxFit.contain,
                    ),
