...
class LightModeTheme extends FlutterTheme {
  ...
  late Color primary = const Color(0xFF2D3142);
  late Color secondary = const Color(0xFF4F5D75);
  late Color tertiary = const Color(0xFFBFC0C0);
  late Color alternate = const Color(0xFFEF8354);
  ...
  late Color accent3 = const Color(0xFF838383);
...
class DarkModeTheme extends FlutterTheme {
  ...
  late Color secondary = const Color(0xFF2D3142);
  late Color tertiary = const Color(0xFF4F5D75);
  late Color alternate = const Color(0xFF4F5D75);
