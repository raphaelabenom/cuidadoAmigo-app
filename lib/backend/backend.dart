...
import 'schema/caregiver_record.dart';
...
export 'schema/caregiver_record.dart';
...
/// Functions to query CaregiverRecords (as a Stream and as a Future).
Future<int> queryCaregiverRecordCount({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      CaregiverRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<CaregiverRecord>> queryCaregiverRecord({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
    ...
    queryCollection(
      CaregiverRecord.collection(parent),
      CaregiverRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<CaregiverRecord>> queryCaregiverRecordOnce({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
